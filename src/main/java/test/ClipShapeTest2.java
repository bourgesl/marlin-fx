...
public class ClipPathTest {
    ...
    static int NUM_TESTS = 5000; // 5000;
    ...
    public static class MyApp extends Application {
        ...
        public void start(Stage primaryStage) throws Exception {
            ...
            resultcv = new Canvas(TESTW, TESTH);
/*
            final GraphicsContext gc = resultcv.getGraphicsContext2D();

            gc.strokeOval(0, 0, TESTW, TESTH);
*/
            root.setCenter(resultcv);

            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.setTitle("Testing " + SHAPE_MODE);
            stage.show();
    ...
    public static void initArgs(String[] args) {
        ...
        switch(SHAPE_MODE) {
            case TWO_CUBICS:
                ...
                THRESHOLD_DELTA = 32;   // 32 / 256
                THRESHOLD_NBPIX = 128; // 128 / 10000
                break;
            case FOUR_QUADS:
            case MIXED:
...
/*
  ...
  */
        ...
        System.out.println("ClipPathTest: image = " + TESTW + " x " + TESTH);
    }
...
// none
    ...
    int paintPaths(final TestSetup ts) throws IOException {
        final long start = System.nanoTime();
        ...
        try {
            ...
            for (int n = 0; n < NUM_TESTS; n++) {
                ...
                diffImage = computeDiffImage(testCtx, prOn, prOff, prDiff, globalCtx);
                ...
                if (diffImage != null) {
                    ...
                    // TODO: update main scene with worst result !
                }
            }
        } finally {
            if (nd != 0) {
 ...
 */
    ...
    public static PixelWriter computeDiffImage(final DiffContext localCtx,
