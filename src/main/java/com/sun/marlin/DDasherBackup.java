 ...
 *
 */
public final class DDasherBackup implements DPathConsumer2D, MarlinConst {
     ...
     */
    DDasherBackup(final DRendererContext rdrCtx) {
        this.rdrCtx = rdrCtx;
     ...
     */
    public DDasherBackup init(final DPathConsumer2D out, double[] dash, int dashLen,
